const noticeList = [
  {
    ...
    1.	시스템의 긴급점검, 증설, 교체, 시설의 보수 또는 공사를 위해 필요한 경우
    2.	시스템 또는 기타 서비스 설비의 장애, 유무선 Network 장애 등으로 정상적인 서비스 제공이 불가능한 경우
    3.	국가비상사태, 정전, 불가항력적 사유에 의한 경우
    ...
    1.	허위 또는 과장된 상품정보를 게재한 경우
    2.	관계 법령에 위반하는 등 부적합 상품을 등록 또는 판매한 경우 
    3.	'판매회원'이 비밀누설하거나 본 약관에 위반하여 고객정보를 이용한 경우 
    4.	'판매회원'이 본 약관의 의무를 위반하여 '회사'가 그 개선을 요청하였으나, 정당한 사유없이 이를 이행하지 아니한 경우 
    5.	'판매회원'이 본 약관에 정한 의무를 누적 3회 위반한 경우
    6.	'판매회원'이 '일반회원'에게 직거래 유도행위를 한 경우 
    7.	'판매회원'이 1년 이상 로그인 하지 않아 휴면계정 처리된 경우 
    8.	'회사'의 시스템 및 서비스를 악용하여 스팸정보전송, 악성프로그램 유포 등 법령에서 금지하는 행위를 한 경우
    2.	본 약관의 당사자 중 일방에게 다음 각 호의 사유가 발생한 경우 그 상대방은 별도의 최고 없이 계약 해지 의사를 통지하여 본 계약을 해지할 수 있습니다. 
    1.	본 약관의 의무를 위반하여 상대방 당사자로부터 시정을 요구 받은 후 7일이 경과할 때 까지 특별한 사유나 해명 없이 이를 시정하지 아니한 경우
    2.	감독기관에 의하여 영업 또는 허가의 취소 또는 정지 등 처분을 받은 경우 
    3.	파산, 화의 또는 회사정리 절차의 신청이 있거나 스스로 이를 신청한 경우 
    4.	발행한 어음 또는 수표가 부도로 되거나 은행과의 거래가 정지된 경우 
    5.	현저하게 상대방의 명예를 훼손한 경우 
    6.	기타 계약기간 내 계약의 이행이 불가능 하거나, 계약 목적을 달성할 수 없게 할 만한 중대한 사유가 발생한 경우 
    3.	본 약관에 따라 '이용계약'이 해지된 경우 그 해지된 날 기준으로 본 약관에서 정하는 절차에 따라 판매대금을 정산합니다. 
    4.	본 약관에 따라 '이용계약'이 해지된 경우에도 해지 시까지 발송되지 아니한 주문된 상품 또는 교환 또는 환불 요청을 받은 상품이 있는 경우 판매자는 상품의 배송, 교환 및 환불에 필요한 협력을 다하여야 할 의무가 있으며 본 의무는 판매대금의 정산이 완료되거나 '구매자'에 대한 모든 조치가 완료된 것이 확인된 경우 종료합니다.
    ...
    4.	개인사업자가 법인으로 또는 법인이 개인사업자로 변경된 경우
    5.	기타 연락전화 및 휴대전화, 전자우편주소 등의 변경이 있는 경우 
    ...
    2.	회원자격이 제한 또는 정지된 '일반회원'이 구매를 신청한 경우
    3.	재판매, 기타 부정한 방법이나 목적으로 구매 신청하였음이 인정되는 경우 
    4.	기타 구매신청을 승낙하는 것이 '판매회원'의 기술상 현저한 지장을 초래하는 것으로 인정되는 경우
    ...
    2.	선불카드, 직불카드, 신용카드 등 각종 카드결제
    3.	'회사'가 지급한 결제 가능한 적립금에 의한 결제
    2.	'회사'는 '일반회원'이 결제수단에 대한 정당한 사용권한을 가지고 있는지 여부를 확인할 수 있으며, 이에 대한 확인이 완료될 때까지 거래 진행을 중지하거나, 확인이 불가능한 거래를 취소할 수 있습니다.
    3.	'회사'의 정책 및 결제업체(이동통신사, 카드회사 등) 또는 결제대행업체(PG)의 기준에 따라 '일반회원' 당 월 누적 결제액 및 충전한도정당한 사용권한을 가지고 있는지 여부를 확인할 수 있으며, 이에 대한 확인이 완료될 때까지 거래 진행을 중지하거나, 확인이 불가능한 거래를 취소할 수 있습니다.
    4.	'회사'의 정책 및 결제업체(이동통신사, 카드회사 등) 또는 결제대행업체(PG)의 기준에 따라 '일반회원' 당 월 누적 결제액 및 충전한도가 제한될 수 있습니다.
    ...
    1.	'일반회원'에게 책임있는 사유로 상품이 멸실 또는 훼손된 경우(다만, 재화를 확인하기 위하여 포장 등을 훼손한 경우는 예외로 합니다)
    2.	'일반회원'의 사용 또는 소비에 의하여 재화의 가치가 현저히 감소한 경우
    3.	시간의 경과로 재판매가 곤란할 정도로 재화의 가치가 현저히 감소한 경우
    4.	같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본이 되는 재화의 포장을 훼손한 경우
    5.	'일반회원'의 주문에 의하여 개별적으로 생산한 제품으로서 청약철회 및 교환의 제한에 대하여 사전에 고지한 경우
    3.	'판매회원' 또는 '회사'가 전 항의 청약철회 제한 사유를 '일반회원'가 알기 쉽게 명시하거나, 시용상품을 제공하는 등의 조치를 취하지 않은 경우 '구매자'의 청약철회가 제한되지 않습니다.
