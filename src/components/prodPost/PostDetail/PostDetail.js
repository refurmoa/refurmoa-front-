...
function PostDetail() {
  ...
  const [bidPrice, setBidPrice] = useState(
    prodInfo.cur_price + prodInfo.unit_price
  ); // 입찰가
  ...
  const getDday = () => {
    ...
    return (
      <li className="PD-price_info_text">
        ...
        {day !== 0 && (
          <>
            <span className={red ? "PD-timer_num_red" : "PD-timer_num"}>
              {day}
            </span>
            <span className={red ? "PD-timer_text_red" : "PD-timer_text"}>
              일&nbsp;
            </span>
          </>
        )}
  ...
  const bidListMap = bidList.map((li) => (
    <li className="PD-bid_list_line" key={li.bid_num}>
      <span className="PD-bid_list_id">
        {login_id === "admin" || login_id === li.member_id
          ? li.member_id
          : li.member_id.slice(0, 2) + "*".repeat(li.member_id.length - 2)}
        {li.bid_auto === 1 && <span className="PD-bid_list_auto"> [자동]</span>}
      </span>
      <span className="PD-bid_list_price">
        {li.bid_price.toLocaleString("ko-KR")}원
      </span>
    ...
    <div className="PD-wrap">
      ...
      <div className="PD-top">
        <span className="PD-selltype">
          <span
            className={
              prodInfo.sell_type === 2
                ...
                : state === 1
                ? "PD-selltype_circle"
                : "PD-selltype_circle_end"
            }
          ></span>
          <span
            className={
              prodInfo.sell_type === 2 ? "PD-selltype_none" : "PD-selltype_text"
            }
          >
            경매
          </span>
          ...
          <span
            className={
              prodInfo.sell_type === 1 ? "PD-selltype_none" : "PD-selltype_text"
            }
          >
            즉시구매
          </span>
        ...
        {login_id === "admin" && (
          <span className="PD-update_delete">
            {state === 0 && <Link to={`/post/update/${board_num}`}>수정</Link>}
      ...
      <div className="PD-info_wrap">
        ...
        <span className="PD-main_image_wrap">
          <div className="PD-star_position">
            <img
              className="PD-main_image"
              alt="상품이미지"
              src={`/images/${prodInfo.main_image}`}
            ></img>
            {!starState ? (
              <img
                className="PD-star"
        ...
        <span className="PD-info_text">
          ...
          <div className="PD-price">
            {prodInfo.sell_type === 2 ? (
              <span className="PD-org_price_cancel">
                {prodInfo.org_price.toLocaleString("ko-KR")}원
              </span>
            ) : (
            ...
            <span className="PD-price_num">
              {prodInfo.cur_price.toLocaleString("ko-KR")}
            </span>
          ...
          <ul className="PD-main_info_text_wrap">
            <li className="PD-main_info_text">
              ...
              <img
                className="PD-main_info_icon"
                alt="상품 상태 상세정보"
                src={info_icon_brown}
                onClick={InfoIconClick("grade")}
              ></img>
            </li>
            {prodInfo.sell_type !== 2 && (
              <>
                ...
                <li className="PD-main_info_text">
                  ...
                  <span className="PD-main_info_text_gray">
                    {prodInfo.auction_price.toLocaleString("ko-KR")}원
                  </span>
                </li>
              </>
            )}
            ...
            <li className="PD-main_info_text">
              ...
              <span>
                {prodInfo.as_date === 0
                  ? `A/S 불가`
                  : `구매 후 ${prodInfo.as_date}년`}
              </span>
            </li>
            <li className="PD-main_info_text">
              <span>배송설치비</span>
              <span>
                {prodInfo.delivery_price === 0
                  ? "무료"
                  : `${prodInfo.delivery_price.toLocaleString("ko-KR")}원`}
              </span>
              <img
                className="PD-main_info_icon"
                alt="배송설치비 상세정보"
                src={info_icon_brown}
                onClick={InfoIconClick("delivery")}
              ></img>
            </li>
          </ul>
          ...
          {/* 즉시구매/판매완료 버튼 */}
          {state === 0 ? (
            <div className="PD-buy_btn_gray">
              {prodInfo.start_date} 오픈 예정
            </div>
          ) : state === 2 ? (
          ...
          {prodInfo.sell_type !== 2 && state === 1 && (
            <>
              <ul className="PD-price_info_wrap">
                ...
                <li className="PD-price_info_text">
                  <span>현재가</span>
                  <span className="PD-current_price_num">
                    {prodInfo.cur_price.toLocaleString("ko-KR")}
                  </span>
                ...
                <li className="PD-price_info_text">
                  <span>
                    입찰가
                    <img
                      className="PD-bid_info_icon"
                      alt="입찰방법"
                      src={info_icon_brown}
                      onClick={InfoIconClick("bid_info")}
                    ></img>
                  </span>
                  <span className="PD-bid_price_wrap">
                    {bidPrice === prodInfo.cur_price + prodInfo.unit_price ? (
                      ...
                      <button
                        className="PD-bid_price_0"
                        onClick={() => {
                          bidPriceUpdate("minus");
                        }}
                      >
                        &lt;
                      </button>
                    ...
                    <span className="PD-bid_price_2">
                      {bidPrice} <span>원</span>
                    </span>
                    <span
                      className={
                        prodInfo.direct_price !== null &&
                    ...
                    <span
                      className={
                        prodInfo.direct_price !== null &&
                        bidPrice >= prodInfo.direct_price - prodInfo.unit_price
                          ? "PD-bid_price_none"
                          : "PD-bid_price_4"
                      }
                    >
              ...
              <div className="PD-buy_btn_wrap">
                ...
                {prodInfo.sell_type === 3 && (
                  <button
                    className="PD-buy_btn_line"
                    type="button"
                    onClick={directBuy}
                  >
                    {prodInfo.direct_price.toLocaleString("ko-KR")}
                    <span>원에</span> 즉시 구매<span>하기</span>
                  </button>
                )}
              </div>
              ...
              <div
                className={
                  !bidListState ? "PD-bid_list_wrap_closed" : "PD-bid_list_wrap"
                }
              >
                <div className="PD-bid_list_title_wrap">
                  <span className="PD-bid_list_title">
                    ...
                    <img
                      className={
                        !bidListState ? "PD-arrow_icon_closed" : "PD-arrow_icon"
                      }
                      alt="입찰내역"
                      src={arrow_icon_brown}
                      onClick={bidListOut}
                    ></img>
                  </span>
                </div>
                {bidListState && <ul className="PD-bid_list">{bidListMap}</ul>}
              </div>
          ...
          <div className="PD-deffect_wrap">
            <div className="PD-deffect_title_wrap">
              ...
              <img
                ...
                alt="하자정보"
                src={info_icon_brown}
                onClick={InfoIconClick("DeffectInfo")}
              ></img>
            </div>
            {login_id === null ? (
              <div className="PD-deffect_content_notlogin">
                로그인 후 확인 가능합니다
              </div>
            ) : (
              <>
                <div className="PD-deffect_content">
                  {prodInfo.deffect_text}
                </div>
                {prodInfo.deffect_image1 !== null && (
                  <div className="PD-deffect_image_wrap">
                    <img
                      className="PD-deffect_image"
                      alt="하자이미지1"
                      src={`/images/${prodInfo.deffect_image1}`}
                      onClick={() => {
                        imageViewChange(1);
                      }}
                    ></img>
                    {prodInfo.deffect_image2 === null ? (
                      <span className="PD-noImage">
                        no
                        <br />
                        image
                      </span>
                      ...
                      <img
                        className="PD-deffect_image"
                        alt="하자이미지2"
                        src={`/images/${prodInfo.deffect_image2}`}
                        onClick={() => {
                          imageViewChange(2);
                        }}
                      ></img>
                    )}
                    {prodInfo.deffect_image3 === null ? (
                      <span className="PD-noImage">
                        no
                        <br />
                        image
                ...
                {imageView !== 0 && (
                  <div
                    className="PD-deffect_image_modal_wrap"
                    onClick={() => {
                      imageViewChange(4);
                    }}
                  >
                    {imageView === 1 ? (
                      <img
                        className="PD-deffect_image_modal"
                        alt="하자이미지1"
                        src={`/images/${prodInfo.deffect_image1}`}
                        onClick={() => {
                          imageViewChange(1);
      ...
      <div className="PD-detail_info_wrap">
        <div className="PD-detail_info_menu">
          <span
            className={
              detailInfo === 1
                ? "PD-detail_info_title_on"
                : "PD-detail_info_title"
            }
            onClick={() => {
              setDetailInfo(1);
            }}
        ...
        <div className="PD-detail_info_content">
          {detailInfo === 1 ? (
            <PostProdDetail detail_image={prodInfo.detail_image} />
          ) : detailInfo === 2 ? (
            <ProdInquiry board_num={board_num} login_id={login_id} />
          ) : (
